<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">基于推荐算法的电影推荐系统注册</h1>
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20220121/3d04e9f657a241328062fa758f18fb72.png);
      ...
      box-sizing: border-box;
        ...
        .send-code {
          ...
          line-height:44px;
					...
					border-color: rgba(31, 63, 80, 1);
					border-radius: 4px;
					background-color: rgba(31, 63, 80, 1);
          box-shadow: 0 0 6px rgba(255,0,0,0);
				}
